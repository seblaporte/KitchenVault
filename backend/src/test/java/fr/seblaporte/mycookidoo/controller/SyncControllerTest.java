...
import fr.seblaporte.mycookidoo.mapper.SyncMapper;
import fr.seblaporte.mycookidoo.service.SyncRunService;
import fr.seblaporte.mycookidoo.service.SyncService;
...
@WebMvcTest(controllers = {SyncDelegate.class})
...
class SyncControllerTest {
    ...
    void triggerSync_returnsAccepted() throws Exception {
        ...
        SyncRunDto dto = makeSyncRunDto(SyncRunDto.StatusEnum.RUNNING);
    ...
    void getLatestSync_whenExists_returnsOk() throws Exception {
        SyncRun run = SyncRun.start();
        SyncRunDto dto = makeSyncRunDto(SyncRunDto.StatusEnum.SUCCESS);
    ...
    private SyncRunDto makeSyncRunDto(SyncRunDto.StatusEnum status) {
