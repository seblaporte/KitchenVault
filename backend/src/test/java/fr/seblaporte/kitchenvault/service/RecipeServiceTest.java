...
class RecipeServiceTest {
    ...
    void listRecipes_noFilters_callsFindAllWithNullSpec() {
        ...
        Page<Recipe> result = recipeService.listRecipes(null, null, null, null, null, null, pageable);
    ...
    void listRecipes_withSearch_callsFindAllWithSpec() {
        ...
        Page<Recipe> result = recipeService.listRecipes("tarte", null, null, null, null, null, pageable);
    ...
    void listRecipes_withBlankSearch_treatsAsNoFilter() {
        ...
        recipeService.listRecipes("   ", null, null, null, null, null, pageable);
    ...
    void listRecipes_withCategoryAndDifficultyFilters_callsFindAllWithSpec() {
        ...
        recipeService.listRecipes(null, List.of("cat-1"), List.of("easy"), 30, List.of("col-1"), null, pageable);

        verify(recipeRepository).findAll(any(Specification.class), any(Pageable.class));
    }

    @Test
    void listRecipes_withIngredientNames_callsFindAllWithSpec() {
        Pageable pageable = PageRequest.of(0, 20);
        when(recipeRepository.findAll(any(Specification.class), any(Pageable.class))).thenReturn(Page.empty());

        recipeService.listRecipes(null, null, null, null, null, List.of("poulet"), pageable);

        verify(recipeRepository).findAll(any(Specification.class), any(Pageable.class));
    }

    @Test
    void listRecipes_withBlankIngredientName_skipsBlankEntry() {
        Pageable pageable = PageRequest.of(0, 20);
        when(recipeRepository.findAll(any(Specification.class), any(Pageable.class))).thenReturn(Page.empty());

        recipeService.listRecipes(null, null, null, null, null, List.of("  "), pageable);
